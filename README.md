project communication channel<br>
dev slack: donutfino.slack.com<br>
dev skype: donut.fino<br><br>
...
The CD already setup for this repo, all the commits will trigger a static deploy to (http://admin.onemap.co.s3-website-ap-southeast-1.amazonaws.com).
